...
namespace {
    ...
    public:
        ...
        NActors::TInterconnectSessionRdma* GetSession() const noexcept {
            return std::get<NActors::TInterconnectSessionRdma*>(Res);
        }
    ...
    public:
        ...
        {}
        void virtual Call(TInterconnectProxyTCP* const /*proxy*/) override {
            IActor::InvokeOtherActor(*Session, &TInterconnectSessionRdma::ToDataMode);
        }
        void virtual ReportError(TString error) override {
            Err = std::move(error);
        }
    ...
    public:
        ...
        void Run() override {
            ...
            if (!DoSwitchToDataMode(session, error)) {
                LOG_LOG_IC_X(NActorsServices::INTERCONNECT, "ICRDMA", NActors::NLog::PRI_ERROR,
    ...
    private:
        void Finish(TString error = {}) {
            if (error) {
                ...
                Send(Creator, new TEvRdmaSyncResult());
            }
        }
